...
REM Tasinalir Git var mi kontrol et
...
REM Git kullanilamiyor, surum kontrolunu atla
goto :skip_version_check

:git_done_s3

REM Surum kontrolu icin Python betigini kullan (bat dosyasi iki nokta sorununu onle)
python packaging\check_version.py --brief 2>nul

:skip_version_check
REM Proje kok dizinine gec
cd /d "%~dp0"

REM Qt arayuzunu baslat
echo Baslatiliyor...
echo ========================================
echo.
